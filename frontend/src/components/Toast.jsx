      ...
      {toast && (
        <div className="fixed bottom-6 right-6 z-50 max-w-md w-full px-4 pointer-events-none">
          <div
            role="status"
            aria-live="polite"
            className="animate-toast pointer-events-auto p-4 rounded-2xl border border-[var(--border-subtle)] bg-[var(--bg-card)] text-[var(--text-main)] flex items-center justify-between shadow-2xl backdrop-blur-xl"
          >
